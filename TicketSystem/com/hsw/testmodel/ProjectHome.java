...
public class ProjectHome {
	...
	public Project findById(java.lang.Integer id) {
		...
		try {
			Project instance = (Project) sessionFactory.getCurrentSession().get("com.hsw.testmodel.Project", id);
			if (instance == null) {
	...
	public List findByExample(Project instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.hsw.testmodel.Project")
