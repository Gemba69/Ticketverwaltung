...
public class CommentHome {
	...
	public Comment merge(Comment detachedInstance) {
		...
		try {
			Comment result = (Comment) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Comment findById(java.lang.Integer id) {
		...
		try {
			Comment instance = (Comment) sessionFactory.getCurrentSession().get("com.hsw.testmodel.Comment", id);
			if (instance == null) {
	...
	public List findByExample(Comment instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.hsw.testmodel.Comment")
