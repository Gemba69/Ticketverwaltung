...
public class TagHome {
	...
	public Tag findById(java.lang.Integer id) {
		...
		try {
			Tag instance = (Tag) sessionFactory.getCurrentSession().get("com.hsw.testmodel.Tag", id);
			if (instance == null) {
	...
	public List findByExample(Tag instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.hsw.testmodel.Tag")
