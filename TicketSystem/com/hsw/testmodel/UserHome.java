...
public class UserHome {
	...
	public User findById(java.lang.String id) {
		...
		try {
			User instance = (User) sessionFactory.getCurrentSession().get("com.hsw.testmodel.User", id);
			if (instance == null) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.hsw.testmodel.User")
