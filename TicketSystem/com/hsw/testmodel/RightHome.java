...
public class RightHome {
	...
	public Right merge(Right detachedInstance) {
		...
		try {
			Right result = (Right) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Right findById(java.lang.Integer id) {
		...
		try {
			Right instance = (Right) sessionFactory.getCurrentSession().get("com.hsw.testmodel.Right", id);
			if (instance == null) {
	...
	public List findByExample(Right instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.hsw.testmodel.Right")
