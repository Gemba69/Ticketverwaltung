...
public class TicketHome {
	...
	public Ticket merge(Ticket detachedInstance) {
		...
		try {
			Ticket result = (Ticket) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Ticket findById(java.lang.Integer id) {
		...
		try {
			Ticket instance = (Ticket) sessionFactory.getCurrentSession().get("com.hsw.testmodel.Ticket", id);
			if (instance == null) {
	...
	public List findByExample(Ticket instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.hsw.testmodel.Ticket")
